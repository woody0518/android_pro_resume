...
public class ArcLayout extends ViewGroup {
    ...
    DismissListener dissMissListener;
    ...
    public void setDismissListener( DismissListener dissMissListener){
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if(mFromDegrees==270&&mToDegrees==450||mFromDegrees==90&&mToDegrees==270){
        	setMeasuredDimension(size/2+mChildSize/2+mChildPadding+mLayoutPadding, size);
        	if(parent!=null){
        		LayoutParams layoutParams = parent.getLayoutParams();
        		layoutParams.width=size/2+mChildSize/2+mChildPadding+mLayoutPadding;
        		layoutParams.height =LayoutParams.WRAP_CONTENT;
        		parent.setLayoutParams(layoutParams);
        	}
        }else{
        	setMeasuredDimension(size, size/2+mChildSize/2+mChildPadding+mLayoutPadding);
        	if(parent!=null){
        		LayoutParams layoutParams = parent.getLayoutParams();
        		layoutParams.height=size/2+mChildSize/2+mChildPadding+mLayoutPadding;
...
//        final int centerX =getWidth()/2;
        ...
        if(mFromDegrees==270&&mToDegrees==450){
        	centerX =mChildSize/2;
        }else if(mFromDegrees==90&&mToDegrees==270){
        	centerX = getWidth()-mChildSize/2;
        }else if(mFromDegrees==0&&mToDegrees==180){
        	centerY =mChildSize/2;
        }else if(mFromDegrees==180&&mToDegrees==360){
        	centerY=getHeight()-mChildSize/2;
        }
...
//        final int centerX = getCh360ildSize()/2;
