...
package com.woody.widget.capricorn;
...
import com.woody.resume.R;

import xuanfu.FloatContentWindow;
import xuanfu.ResouceUtil;
...
public class ArcMenu extends RelativeLayout {
    ...
    public static final int GRIVATY_LEFT = 1;
    public static final int GRIVATY_RIGHT = 2;
    public static final int GRIVATY_TOP = 3;
    public static final int GRIVATY_BOTTOM = 4;
    public void setCtrollLayoutGrivaty(int grivaty){
    	LayoutParams lp =(LayoutParams) controlLayout.getLayoutParams();
    	if(grivaty==GRIVATY_RIGHT){
    	...
    	}else if(grivaty == GRIVATY_BOTTOM){
    		if(Build.VERSION.SDK_INT >= 17){
    			lp.removeRule(RelativeLayout.ALIGN_PARENT_LEFT);
        		lp.removeRule(RelativeLayout.ALIGN_PARENT_TOP);
        		lp.removeRule(RelativeLayout.ALIGN_PARENT_RIGHT);
    ...
    FloatContentWindow popupWindow;
    public void setWindow(FloatContentWindow popupWindow){
    	this.popupWindow = popupWindow;
    }
    private void init(Context context) {
        LayoutInflater li = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        li.inflate(R.layout.arc_menu, this);
        li.inflate(ResouceUtil.getLayoutId(context, "arc_menu"), this);

//        mArcLayout = (ArcLayout) findViewById(R.id.item_layout);
//        controlLayout = (ViewGroup) findViewById(R.id.control_layout);
        mArcLayout = (ArcLayout) findViewById(ResouceUtil.getId(context, "item_layout"));
        controlLayout = (ViewGroup) findViewById(ResouceUtil.getId(context, "control_layout"));
...
//        mHintView = (ImageView) findViewById(R.id.control_hint);
        mHintView = (ImageView) findViewById(ResouceUtil.getId(context, "control_hint"));
    }
    ...
    public void showItem(boolean b){
    	mArcLayout.switchState(b);
    }
...
//                mHintView.startAnimation(createHintSwitchAnimation(true));
    ...
    private void itemDidDisappear() {
        ...
        popupWindow.setIsItemClick(true);
        if(popupWindow!=null){
        	popupWindow.dismiss();
        }
    }
